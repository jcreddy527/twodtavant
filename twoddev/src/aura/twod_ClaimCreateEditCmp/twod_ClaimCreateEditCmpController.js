                        ...
                        case "Serialized":
                            {
                                ...
                                var query = "select Id,Name,Warranty_Product__c,Fault_Code__r.Id,Fault_Code__r.Name " +
                                    "from FaultCode_Mapper__c where Warranty_Product__c IN('" + modelId + "','" + causalPart['Id'] + "') " +
                                ...
                                helper.readRaw(component, event, helper, query, function(allFaultCodeResponse) {
                                    ...
                                    var intersectedFaultCodeList = helper.intersectionByProperty(modelFaultCodeList, causalPartFaultCodeList);
                                    ...
                                    if (intersectedFaultCodeList.length == 0) {
                                        ...
                                        if (modelFaultCodeList !== undefined && modelFaultCodeList !== null && modelFaultCodeList.length != 0) {
                                            helper.setFaultCodePicklistOptions(component, modelFaultCodeList, 0);
                        ...
                        case "Non-Serialized":
                            {
                                ...
                                "from FaultCode_Mapper__c where Warranty_Product__c='" + causalPart['Id'] + "' "
                                "AND Fault_Code__r.Lang_Id__c='" + userLangId + "' AND Fault_Code__r.Selectable__c=true";
                                        ...
                                        helper.updateRaw(component, event, helper, updatableNonOEMPart, function(nonOEMPartUpdateResponse) {
                                            ...
                                            if (nonOEMPartUpdateResponse['sobjectsAndStatus'] != undefined &&
                                                ...
                                                if (isSuccessfulUpdate == 'successful') {
                                                    ...
                                                    updateedNONOEMpart['Miscellaneous_Part_Name__c'] = targetNONOEMPart['Name'];
            ...
            case "Validate":
                {
                    ...
                    if (claimBasicInfoValidated) {
                        ...
                        if (removedPartList.length != 0) {
                            ...
                            var query = "select Id,Name,Warranty_Product__r.Id,Warranty_Product__r.Name," +
                                "Inventory__r.Id,Inventory__r.Name,Quantity__c,Return_Location__r.Name " +
                    ...
                    if (!accordionValidated) {
                        ...
                        helper.readRaw(component, event, helper, queryForDuplicateFinder, function(duplicateClaimresponse) {
                            ...
                            if (sobjectList !== null && sobjectList !== undefined &&
                                ...
                                currentClaim['Possible_Duplicate_Claim__c'] = sobjectList[0]['Id'];
                            } else {
                                currentClaim['Possible_Duplicate_Claim__c'] = '';
                            }

                            // insert the claim
                            helper.insertRaw(component, event, helper, currentClaim, function(claimInsertResponse) {

                                console.log('claim create response');
                                console.log(claimInsertResponse);
