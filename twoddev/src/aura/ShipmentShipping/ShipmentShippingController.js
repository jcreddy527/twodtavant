({
    doInit : function(component, event, helper) {
        ...
        var query = "select Id,Receiver_Comments__c,Shipment_Received_Date__c,Name"+
            ",Carrier__c,isShipped__c,Shipper_Comments__c,Received__c,Tracking_Number__c,Return_Location__r.Name,Shipment_Date__c, (Select id,Quantity__c,Shipment_Detail__c,Is_Received__c,Removed_Claim_Part__c,Removed_Claim_Part__r.Warranty_Product__r.Name,Removed_Claim_Part__r.Warranty_Product__r.Description__c,Removed_Claim_Part__r.Inventory__c,Removed_Claim_Part__r.Inventory__r.Item__c,Removed_Claim_Part__r.Inventory__r.Item__r.Name,Removed_Claim_Part__r.Inventory__r.Item__r.Description__c,Removed_Claim_Part__r.Inventory__r.Name from Claim_Shipments__r) from Shipment_Detail__c where Id = '" + component.get("v.shipmentId") + "'";	
                ...
                if(shipmentResponse['sObjectList']!==null && 
                   ...
                   shipmentResponse['sObjectList'].length!==0){				
                    ...
                    if(shipmentObject!=null){
                        if(shipmentObject['isShipped__c']!== null && 
                           shipmentObject['isShipped__c']!==undefined){
                            if(shipmentObject['isShipped__c']==false){
                                ...
                                shipmentObject['isShipped__c'] = true;  
                            }else{
