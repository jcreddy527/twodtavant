({
    ...
    doInit: function(component, event, helper) {
        ...
        if (isEdit != undefined && isEdit == false) {
            ...
            //add the inventory automatically when new claim create from inventory page - added by siva             
             var inventory = JSON.parse(JSON.stringify(component.get('v.inventory12')));
             console.log('inventory'+JSON.stringify(inventory));
             	if (inventory != null && inventory != undefined) {
                    var inventory = JSON.parse(inventory);                   
                	component.find('inventory').set('v.objectName', inventory['Name']);
                    component.set('v.currentClaim.Inventory__c', inventory['Id']);
            ...
            case "inventory":
                {
                    ...
                    /*if(claimCustomRecordTypeName === 'Preventive Maintenance'){
                    	helper.getInventoryUpcomingSchedule(component, event, inventory['Id']);
                    }*/
                    break;
                }
                        ...
                        case "Non-Serialized":
                            {
                                ...
                                helper.readRaw(component, event, helper, query, function(causalPartFCResponse) {
                                    ...
                                    console.log(stringFaultCodeList);
