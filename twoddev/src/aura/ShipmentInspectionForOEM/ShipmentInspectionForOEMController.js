                ...
                if(shipmentResponse['sObjectList']!==null && 
                   ...
                   shipmentResponse['sObjectList'].length!==0){				
                    ...
                    if(shipmentObject!=null){
                        ...
                        if(shipmentObject['isInspected_OEM__c']!== null && 
                           shipmentObject['isInspected_OEM__c']!==undefined){
                        
                            if(shipmentObject['isInspected_OEM__c']==false){                                
                                ...
                                shipmentObject['isInspected_OEM__c'] = true;  
                            }else{
