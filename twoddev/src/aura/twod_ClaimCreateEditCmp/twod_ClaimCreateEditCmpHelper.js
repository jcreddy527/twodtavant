({
    ...
    intersectionByProperty: function(givenListA, givenListB) {
        ...
        if ((givenListA === undefined || givenListA === null || givenListA.length !== 0) &&
            (givenListB === undefined || givenListB === null || givenListB.length !== 0)
        ) {
    ...
    initializeFaultCodeListForEditMode: function(component, faultCodeMapperList) {
        ...
        if (claimCustomRecordTypeName === 'Serialized' || claimCustomRecordTypeName === 'Field Modification') {
            ...
            var intersectedFaultCodeList = self.intersectionByProperty(modelFaultCodeList, causalPartFaultCodeList);
            ...
            if (intersectedFaultCodeList.length == 0) {
                ...
                if (modelFaultCodeList !== undefined && modelFaultCodeList !== null && modelFaultCodeList.length !== 0) {
                    component.set('v.faultCodeList', modelFaultCodeList);
                } else {
